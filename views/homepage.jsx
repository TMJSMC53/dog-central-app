      ...
      <div className="bg-white py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-2xl font-semibold text-accent-400">Overview</h2>
          ...
          <div className="mt-10">
            <dl className="space-y-10 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10 md:space-y-0">
              <div className="relative">
                <dt>
                  <div className="absolute flex h-12 w-12 items-center justify-center rounded-md bg-light text-white">
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 lg:text-2xl  font-medium leading-6 text-primary">
                    Store information from vet visits
                  </p>
                </dt>
